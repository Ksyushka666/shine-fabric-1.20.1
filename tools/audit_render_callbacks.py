...
if "BloomSourceRenderer.prepareSource(context)" not in post or "copyTarget(main, chainSource)" not in post:
    errors.append("safe main-target source capture missing")
